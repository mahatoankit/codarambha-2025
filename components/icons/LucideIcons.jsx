...
export const BrainCircuit = ({ className, ...props }) => (
  <svg
    className={className}
    fill="none"
    stroke="currentColor"
  ...
  >
    ...
    <path d="M14 4a4 4 0 0 1 0 8" />
    <path d="M10 8a4 4 0 1 1 0 8 4 4 0 0 1-4-4" />
    <path d="M16 12h4" />
    <path d="M12 16v4" />
    <path d="M8 12H4" />
    <path d="M9 3L7.5 4.5" />
    <path d="M15 3l1.5 1.5" />
    <path d="M3 9l1.5 1.5" />
  </svg>
);
...
export const Lightbulb = ({ className, ...props }) => (
  ...
  >
    <path d="M9 21h6" />
    <path d="M12 17v4" />
    <path d="M12 3a6 6 0 0 0-6 6c0 1.5.5 2.5 1 3.5L8 16h8l1-3.5c.5-1 1-2 1-3.5a6 6 0 0 0-6-6Z" />
  </svg>
);
...
export const Rocket = ({ className, ...props }) => (
  ...
  >
    ...
    <path d="m12 15 3-3a22 22 0 0 1-2 3.95A12.88 12.88 0 0 1 2 22c0-2.72.78-7.5 6-11a22.35 22.35 0 0 1 4-2z" />
    <path d="M12 9v5s3.03-.55 4-2c1.08-1.62 0-5 0-5" />
  </svg>
);

// You can add more Lucide icons here as needed
...
export const Users = ({ className, ...props }) => (
  ...
  >
    ...
    <path d="m22 21-3.5-3.5M20 8a8 8 0 1 0-16 0 8 8 0 0 0 16 0Z" />
  </svg>
);
...
export const Route = ({ className, ...props }) => (
  ...
  >
    ...
    <path d="M9 19h8.5A3.5 3.5 0 0 0 21 15.5v-3A3.5 3.5 0 0 0 17.5 9H15" />
    <circle cx="6" cy="5" r="3" />
    <path d="M9 5h5.5A3.5 3.5 0 0 1 18 8.5v3A3.5 3.5 0 0 1 14.5 15H12" />
  </svg>
);
...
export const Medal = ({ className, ...props }) => (
  <svg
    className={className}
    fill="none"
    stroke="currentColor"
...
export const Lab = ({ className, ...props }) => (
  <svg
    className={className}
    fill="none"
    stroke="currentColor"
    ...
    {...props}
  >
    <path d="M9 2v6l-3 3.5a2 2 0 0 0-.5 1.5V19a2 2 0 0 0 2 2h9a2 2 0 0 0 2-2v-6a2 2 0 0 0-.5-1.5L15 8V2" />
    <path d="M12 2v6" />
    <path d="M9 2h6" />
